...
def record_income_entry(
    ...
    if source_type == "reserve_recovery": return _post_journal(project_id, tx_date, _compose_desc("회수/정산 입금(예비비 복구)", extra_label), "RESERVE_RECOVERY", actor_name, "1110", "1200", amount, note)
